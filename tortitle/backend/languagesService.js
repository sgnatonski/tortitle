...
(function (LanguagesService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getLanguages()];
                    case 1:
                        langs = _a.sent();
                        cache_1.default.set(cacheKey, langs, ttl);
    ...
    function getLanguages() {
        return __awaiter(this, void 0, void 0, function () {
            var languagesTableName, entities, langs, availableLangs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        entities = _a.sent();
                        langs = new Set(entities.map(function (i) { return i.RowKey; }));
